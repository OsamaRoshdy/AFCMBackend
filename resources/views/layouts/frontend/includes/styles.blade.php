...
/>
<link rel="stylesheet" href="{{ asset('/') }}AFMC-project/css/v2/style_{{ app()->getLocale() == 'en' ? 'ltr' : 'rtl' }}.css">
<!--  <link rel="stylesheet" href="AFMC-project/css/v2/style_rtl.css"> -->

<link rel="stylesheet" href="{{ asset('/') }}AFMC-project/css/font-awesome.min.css">
<link rel="stylesheet" href="{{ asset('/') }}AFMC-project/css/hover.css">
