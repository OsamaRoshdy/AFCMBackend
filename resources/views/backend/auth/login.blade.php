        ...
        <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image:url({{ asset('backend/media/bg/bg-3.jpg') }});">
            <div class="login-form text-center p-7 position-relative overflow-hidden">
                ...
                <div class="d-flex flex-center mb-15">
                    <a href="#">
                        <img src="{{ asset('backend/media/logo.png') }}" class="max-h-200px" alt=""  />
                    </a>
                </div>
                <!--end::Login Header-->
                ...
                <div class="login-signin">
                    <div class="mb-20">
                        <h3>Sign In To AFCM AdminPanel</h3>
                        <div class="text-muted font-weight-bold">Enter your details to login to your account:</div>
                    </div>

                    {{ Form::open(['route' => 'dashboard.login', 'id' => '', 'class' => 'form']) }}
                        <div class="form-group mb-5">
                            {{ Form::email('email', old('email'), ['class' => 'form-control h-auto form-control-solid py-4 px-8', 'placeholder' => 'Email', 'autocomplete' => 'off']) }}
                        </div>
                        <div class="form-group mb-5">
                            {{ Form::password('password', ['class' => 'form-control h-auto form-control-solid py-4 px-8', 'placeholder' => 'Password']) }}
                        </div>
                        {{ Form::submit('Sign In', ['id' => 'kt_login_signin_submit', 'class' => 'btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4']) }}
                    {{ Form::close() }}
                </div>
