...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        {!! Form::model($block,['route'=> ['dashboard.' . $module .'.update', $block->id], 'method'=>'patch', 'id' => "kt_form", 'files' => true]) !!}
        <div class="card-body">
            <div class="row">
        ...
        <div class="card-body">
            @foreach($block->images as $image)
                <div class="image-input image-input-outline image-input-changed" id="kt_user_edit_avatar">
                    ...
                    {{ Form::open(['route' => ['dashboard.block_images.destroy', $image->id], 'method' => 'delete']) }}
